...
import { Animated, Easing, View, NativeModules, Modal, StatusBar, TouchableWithoutFeedback, Platform } from 'react-native';
...
class CopilotModal extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      ...
      >
        <TouchableWithoutFeedback onPress={this.props.isLastStep ? this.handleStop : this.handleNext}>
          <View
